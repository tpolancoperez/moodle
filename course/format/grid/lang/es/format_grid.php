...
$string['namegrid'] = 'Parrilla'; // Name of a section within your format.
$string['pluginname'] = 'Vista parrilla';
$string['sectionname'] = 'Sección';
$string['section0name'] = 'General';
$string['title'] = 'Título de la sección';
$string['titlealreadyexist'] = '$a este nombre ya existe. Por favor elige otro.';
$string['topicoutline'] = 'Sección';
$string['updatesection'] = 'Actualiza sección';
