...
function _make_block_icon_topics($without_topic0) {
    ...
    // Remove new activity label of top of images. Line below commented. TP. 02/08/13
    ...
    for($section = $without_topic0 ? 1 : 0;
        ...
        if ($has_cap_vishidsect || $thissection->visible || !$course->hiddensections) {
            ...
            // Remove new activity label of top of images. Lines below commented. TP. 02/08/13
