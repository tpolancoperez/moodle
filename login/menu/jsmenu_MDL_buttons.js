...
aI("text=Listing of Online Courses;url=http://www2.oakland.edu/elis/SO_courses.cfm;status=Listing of Online Courses;image=;");
...
aI("text=Archive Request Form;url=http://www2.oakland.edu/elis/moodlearchives.cfm;status=Archive Request Form;image=;");
...
with(milonic=new menuname("espace")){
style=submenuStyle;
top="offset=2"
margin=3
aI("text=Login to eSpace;url=http://espace.oakland.edu;status=Login to eSpace;image=;");
aI("text=Overview of eSpace;url=http://www2.oakland.edu/elis/espace_overview.cfm;status=Overview of eSpace;image=;");
aI("text=TECHNICAL SUPPORT;type=header;align=center;status=TECHNICAL SUPPORT;image=;");
aI("text=Request Help;url=http://www2.oakland.edu/elis/help.cfm?LMS=4;status=Request Help;image=;");
...
with(milonic=new menuname("e-Cornucopia Conference")){
style=submenuStyle;
top="offset=2"
margin=3
aI("text=About;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=0;status=About;image=;");
aI("text=Schedule;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=1;status=Schedule;image=;");
aI("text=Presentations;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=2;status=Presentations;image=;");
aI("text=Hotels, Transportation;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=3;status=Hotels, Transportation;image=;");
aI("text=Speakers;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=4;status=Speakers;image=;");
aI("text=Registration;url=http://www2.oakland.edu/elis/conference.cfm?countrytabs=5;status=Registration;image=;");
}
...
with(milonic=new menuname("Panopto")){
style=submenuStyle;
top="offset=2"
margin=3
aI("text=Login to Panopto;url=http://lecturecapture.oakland.edu;status=Login to Panopto;image=;");
aI("text=Overview of Panopto;url=http://www2.oakland.edu/elis/panopto.cfm;status=Overview of Panopto;image=;");
}
