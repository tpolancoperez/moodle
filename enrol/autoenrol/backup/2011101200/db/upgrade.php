...
/**
 * This file keeps track of upgrades to the autoenrol enrolment plugin
 *
 * @package    enrol
...
function xmldb_enrol_autoenrol_upgrade($oldversion) {
    ...
    // Add instanceid field to enrol_autoenrol table
    if ($oldversion < 2010071500) {
        $table = new xmldb_table('enrol_autoenrol');
        ...
        upgrade_plugin_savepoint(true, 2010071500, 'enrol', 'autoenrol');
    }
