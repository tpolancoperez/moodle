 ...
 * @return string 
 */
function fulleronline_process_css($css, $theme) {
    ...
    $css = fulleronline_set_linkcolor($css, $linkcolor);
    ...
    $css = fulleronline_set_linkhover($css, $linkhover);
    ...
    $css = fulleronline_set_maincolor($css, $maincolor);
    ...
    $css = fulleronline_set_maincoloraccent($css, $maincoloraccent);
   ...
   // Set the main headings color
    ...
    $css = fulleronline_set_headingcolor($css, $headingcolor);
    ...
    $css = fulleronline_set_blockcolor($css, $blockcolor);
    ...
    $css = fulleronline_set_forumback($css, $forumback);
    ...
    $css = fulleronline_set_background($css, $background);
    ...
    $css = fulleronline_set_logo($css, $logo);
 ...
 *
 */
function fulleronline_set_linkcolor($css, $linkcolor) {
...
function fulleronline_set_linkhover($css, $linkhover) {
...
function fulleronline_set_maincolor($css, $maincolor) {
...
function fulleronline_set_maincoloraccent($css, $maincoloraccent) {
...
function fulleronline_set_headingcolor($css, $headingcolor) {
...
function fulleronline_set_blockcolor($css, $blockcolor) {
...
function fulleronline_set_forumback($css, $forumback) {
...
function fulleronline_set_background($css, $background) {
	global $OUTPUT;
...
function fulleronline_set_logo($css, $logo) {
	global $OUTPUT;
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	if (is_null($replacement)) {
