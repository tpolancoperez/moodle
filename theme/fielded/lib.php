 ...
 * @return string 
 */
function fielded_process_css($css, $theme) {
    ...
    $css = fielded_set_linkcolor($css, $linkcolor);
    ...
    $css = fielded_set_linkhover($css, $linkhover);
    ...
    $css = fielded_set_maincolor($css, $maincolor);
    ...
    $css = fielded_set_maincoloraccent($css, $maincoloraccent);
   ...
   // Set the main headings color
    ...
    $css = fielded_set_headingcolor($css, $headingcolor);
    ...
    $css = fielded_set_blockcolor($css, $blockcolor);
    ...
    $css = fielded_set_forumback($css, $forumback);
    ...
    $css = fielded_set_background($css, $background);
 ...
 *
 */
function fielded_set_linkcolor($css, $linkcolor) {
...
function fielded_set_linkhover($css, $linkhover) {
...
function fielded_set_maincolor($css, $maincolor) {
...
function fielded_set_maincoloraccent($css, $maincoloraccent) {
...
function fielded_set_headingcolor($css, $headingcolor) {
...
function fielded_set_blockcolor($css, $blockcolor) {
...
function fielded_set_forumback($css, $forumback) {
...
function fielded_set_background($css, $background) {
	global $OUTPUT;
...
function fielded_set_logo($css, $logo) {
	global $OUTPUT;
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	if (is_null($replacement)) {
