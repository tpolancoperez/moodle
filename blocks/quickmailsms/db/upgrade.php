...
function xmldb_block_quickmail_upgrade($oldversion) {
    ...
    die('Please remove your old quickmailsms instance.');
    /*
        ...
        // Define table block_quickmail_sigs to be created
        $table = new xmldb_table('block_quickmail_sigs');

        // Adding fields to table block_quickmail_sigs
        ...
        // Adding keys to table block_quickmail_sigs
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Conditionally launch create table for block_quickmail_sigs
