...
class block_itunesu_link extends block_base {
  public function init() {
    $this->title = get_string('iTunesU', 'block_itunesu_link');
  }
  function get_content() {
    ...
    $required_content = "<a href=\"http://moodle.fuller.edu/blocks/itunesu_link/connect_to_itunesu.php?id=$id\" target=\"_blank\">Connect to iTunesU</a>";
