...
class block_quickmail extends block_list {
    ...
    function get_content() {
        ...
        if ($can_send) {
            ...
            $this->content->icons[] = $OUTPUT->pix_icon('i/drafts', $drafts_email_str, 'moodle', $icon_class);
            ...
            $this->content->icons[] = $OUTPUT->pix_icon('i/history', $history_str, 'moodle', $icon_class);
        }
