// $Id: checkavailability.js,v 1.1.2.2 2009/10/22 14:28:24 jfilip Exp $
...
/// This function will return the query string to check seat availabilty.
    ...
    return openpopup('/mod/elluminatelive/checkseats.php?' + queryString, 'availability', 'scrollbars=yes,resizable=no,width=640,height=300');
}
