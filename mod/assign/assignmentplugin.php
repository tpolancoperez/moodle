...
abstract class assign_plugin {
    ...
    /** Prevent feedback files being copied to the next student. Patch added by T.P.
    ...
    /**
     * Get any additional fields for the submission/grading form for this assignment.
     * This function is retained for backwards compatibility - new plugins should override {@link get_form_elements_for_user()}.  Line added. T.P.
     * 
