...
class mod_email_sendmail_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('filemanager', 'attachments_filemanager', $label, $attachmentoptions);
        
        
        $mform->addElement('editor', 'body_editor', get_string("body", "email"), null, $bodyoptions);
