...
$string['flaggedposts'] = 'Highlighted posts';
$string['flaggedpostslink'] = '{$a} highlighted posts';
$string['post'] = 'Post';
$string['author'] = 'Author';
$string['clearflag'] = 'Remove highlight';
$string['setflag'] = 'Highlight this post for future reference';
$string['flagon'] = 'You have highlighted this post';
$string['flagoff'] = 'Not highlighted';
$string['postby'] = '(by {$a})';
...
$string['flaggedposts_help'] = 'Highlighted posts appear in this list. To jump to a highlighted post,
click on it.

To remove the highlight from a post, click on the flag icon (here or in the post).';
